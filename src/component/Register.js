...
import './style.css'
import { userCreate,userGet } from '../store/actions/userAction'
...
export default function Register({ lrToggle, setLrToggle, setLoginToggle }) {
  ...
  const {successMessage, errorMessage, lsuccessMessage,lerrorMessage,token,name} = useSelector((state)=>state.user);
